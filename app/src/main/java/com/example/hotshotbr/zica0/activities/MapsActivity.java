...
public class MapsActivity extends FragmentActivity implements
    ...
    public void onClick_Localizacao(View v) {
        Location location = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);
        double currentLatitude = location.getLatitude();
        double currentLongitude = location.getLongitude();
...
//		CameraUpdate update = CameraUpdateFactory.newLatLng(LOCATION_BURNABY);
        ...
        final LatLng LOCATION = new LatLng(currentLatitude,currentLongitude);
    ...
    public void onClick_Causa(View v){
        Intent intent = new Intent(this, CausaActivity.class);
        startActivity(intent);
    }
}
